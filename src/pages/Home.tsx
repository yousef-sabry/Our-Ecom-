...
const Home = () => {
    const navigate = useNavigate(); // تعريف هوك التنقل

  const handleReadMore = () => {
    navigate('/about-us'); // التنقل لصفحة about
  };
  return (
    <Promo>
      <Container>
        <Row className="text-center">
          <Col md={6} className="d-flex flex-column justify-content-center">
            ...
            <PromoDescription>"Discover your unique style with our curated collection of fashion essentials and timeless classics, designed to make every moment memorable."</PromoDescription>
             <Button variant="primary" className="my-2" onClick={handleReadMore}>
              READ MORE
            </Button>
        ...
        <PromoFooter>
          ...
          <PromoSocialLink href="https://wa.me/qr/TC33ZDKZ2K75A1">
            <FaWhatsapp />
          </PromoSocialLink>
          <PromoSocialLink href="#">
            <FaFacebookF />
